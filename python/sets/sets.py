...
def categorize_dish(dish_name: str, dish_ingredients: list) -> str:
    ...
    raise ValueError(f"The ingredients of {dish_name} do not match any category")
...
def compile_ingredients(dishes: list) -> set:
    ...
    for dish in dishes:
        compiled_ingredients = compiled_ingredients.union(dish)
...
def singleton_ingredients(dishes: list, intersection: set) -> set:
    ...
    compiled_ingredients = set()
    for dish in dishes:
        compiled_ingredients = compiled_ingredients.symmetric_difference(dish)
